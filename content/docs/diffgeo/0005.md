...
$$
\boxed{T_{(a_1,\dots,a_l)}:=\frac{1}{l!}\sum_{\pi}{T_{a_{\pi(1)}},\dots,T_{a_{\pi(l)}}}\\ \quad \\ T_{[a_1,\dots,a_l]}:=\frac{1}{l!}\sum_{\pi}{\delta_{\pi} T_{a_{\pi(1)}},\dots,T_{a_{\pi(l)}}}}
$$
...
**全对称张量的反称部分为０，反之亦然**：
$$
\boxed{T_{a_1,\dots,a_l}=T_{(a_1,\dots,a_l)} \Rightarrow T_{[a_1,\dots,a_l]}=0\\ \quad \\ T_{a_1,\dots,a_l}=T_{[a_1,\dots,a_l]} \Rightarrow T_{(a_1,\dots,a_l)}=0}
$$
